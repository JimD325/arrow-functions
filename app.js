...
// Below translated to English: num1 and num2 are parameters for the function addOneLiner
...
let joe = new Student('Joe', 100, 'Yonkers');
...
// let ArrowJoe = new ArrowStudent (ArrowStudent, 22, 67);
...
// The context of this is not reset with an arrow function. Therefore, if this is used within an arrow function, then the context will be in the browser of the global window object. 
